...
|:--:| 
| *NRB data collected during DOE TRACER project by TAMU mobile lab. The gaps show when lidar wasn't collecting data and the gap is handled by the interpolation function.* |
